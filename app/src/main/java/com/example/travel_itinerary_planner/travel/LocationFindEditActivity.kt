...
import com.example.travel_itinerary_planner.databinding.FindLocationEditBinding
...
class LocationFindEditActivity : LoggedInActivity() {
    private lateinit var binding: FindLocationEditBinding
    private val coroutineScope = CoroutineScope(Dispatchers.Main)
    private lateinit var adapter: AddressAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = FindLocationEditBinding.inflate(layoutInflater)
        ...
        binding.listLocation.setOnItemClickListener { _, _, position, _ ->
            ...
            coroutineScope.launch {
                fetchPlaceDetails(selectedAddress.placeId, selectedAddress.description)?.let { placeDetails ->
                    ...
                    val intent = Intent(this@LocationFindEditActivity, LocationEditActivity::class.java).apply {
